/////////////////////////////////////////////////////////////////////////////
//Peer1.cpp - Process the command line arguments                           //
...
void Peer1::Client(int sndPort,int rcvPort, std::string filename)
{
	Receiver r;
...
void Peer1::Server(int endpoint1, int endpoint2)
{
	Display d;
	d.display("\n\n**********************I AM Server [PEER 1]******************************\n\n");
	try
	{
		d.display("\n %%%%%%%%%%%%%%%%%%%%%%Entered Parameters are%%%%%%%%%%%%%%%%%%%%");
		d.display("\n Entered server port number:" + std::to_string(endpoint1));  //Listening port
		d.display("\n %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \n");
		Receiver r;
